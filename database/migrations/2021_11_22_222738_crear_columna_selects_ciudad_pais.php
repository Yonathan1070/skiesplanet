...
class CrearColumnaSelectsCiudadPais extends Migration
{
    ...
    public function up()
    {
        Schema::table('TBL_Tipo_Reserva', function (Blueprint $table) {
            $table->boolean('TTR_Select_Pais_Tipo_Reserva')->nullable()->after('TTR_Costo_Tipo_Reserva');
            $table->boolean('TTR_Select_Ciudad_Tipo_Reserva')->nullable()->after('TTR_Select_Pais_Tipo_Reserva');
        });
    }
